...
R.map(person => ({...person, age: R.inc(person.age)}),
...
```javascript
//Ramda
R.map(person => person.name === "Tom" ? ({...person, age: R.inc(person.age)}) : person,
  [{name: "Tom", age: 22}, {name: "Dick", age: 33}, {name: "Mortimer", age: 44}]
)  
...
// Vanilla
[{name: "Tom", age: 22}, {name: "Dick", age: 33}, {name: "Mortimer", age: 44}]
.map(person => person.name === "Tom" ? ({...person, age: R.inc(person.age)}) : person)
```
...
// Vanilla
["Mary", "Yousef", "John", "Mark"].filter(str => str === "John") // ["John"]
```
...
// Ramda
R.compose(R.head, R.filter(str => str === "John"))(names)  // "John"
